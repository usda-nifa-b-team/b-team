var data=[["Agapostemon femoratus","Angelica",2],
...
; 
 ...
 g1.selectAll(".mainBars").append("text").attr("class","label")
                          ...
                          .attr("x",d=>(d.part=="primary"? -48.8:36.8))
 ...
 g1.selectAll(".mainBars").append("text").attr("class","lab")
                          ...
                          .attr("x",d=>(d.part=="primary"? -287.8:240.8))
