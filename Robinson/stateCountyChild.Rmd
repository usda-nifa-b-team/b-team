...
```{r, include=FALSE}
tCap <- str_c("Top Plant Species and Genera for Bee Richness in ", x, " County.")
```
...
fCap <- paste0("Top: Observed Species in ", x, " County", " Bottom: Number of Additional Species Expected in ", x, " County")

```
\subsection {Bee Richness Highlighted for `r x` County}
```{r, fig.height=7, fig.cap=fCap, fig.pos= "H", out.extra= ""}
cowplot::plot_grid(
